...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      absolute right-0 top-0 z-0 flex h-[40%] flex-col items-center justify-center space-y-10 border-2 border-b-0 border-l-0 sm:w-[25%]"
      >
        <m.div
        ...
        <m.div
          ...
          className="neonTextWorldTour text-3xl font-bold text-[#0f0a1c] sm:text-[60px]"
        >
          Tour
        </m.div>
        <m.div
      ...
      <m.div
        ...
        animate={{ opacity: 1 }}
        transition={{ duration: 1 }}
        className="absolute right-0 top-[40%] z-0 h-[40%] border-2 border-l-0 bg-grid-slate-700 sm:w-[25%]"
      >
        {/* <div className="text-3xl text-slate-400">Grab your</div>
        <div className="mx-auto text-4xl text-slate-100">
          {readCurrentName.state || "Kenya"}
        </div> */}
        <div className="flex h-full w-full flex-col items-center justify-center space-y-4 bg-gradient-to-t from-transparent to-[#1d2a32]">
          <m.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 1, delay: 6 }}
            className={classNames(
              "neonText cursor-pointer rounded-lg border-2 bg-[#0f1629] px-6 text-7xl text-gray-50/80",
        ...
        {/* <svg
          ...
          // xml:space="preserve"
          className="neonTicket h-1/2 cursor-pointer fill-current text-[#9eeded]"
        >
          <g>
            <g>
              <path
        ...
        {/* <div className="text-3xl text-slate-400">for </div> */}
        {/* <div className=" mx-auto text-4xl text-slate-100">
