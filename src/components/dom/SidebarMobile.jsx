...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      absolute right-0 top-0 z-0 flex h-[40%] flex-col items-center justify-center space-y-10 border-2 border-b-0 border-l-0 from-transparent to-[#454e67] bg-grid-slate-700 sm:w-[25%]"
      >
        <m.div
      ...
      <m.div
        ...
        animate={{ opacity: 1 }}
        transition={{ duration: 1 }}
        className="z-0 flex h-1/6 flex-col items-center justify-center space-y-4 border-2 border-l-0  from-transparent to-[#454e67] bg-grid-slate-700 sm:w-[25%]"
      >
        <m.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 4 }}
          className="neonText cursor-pointer rounded-lg border-2 px-6 text-3xl font-bold"
        >
          Buy
        </m.div>
